  ...
  return (
    <div className="sticky top-20 flex flex-col space-y-3">
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 px-1">
        <div className="flex items-center gap-1.5 p-1 rounded-xl bg-[#161b22] border border-[#30363d]">
          <button
            type="button"
          ...
          >
            ...
            {requiredSecrets.length > 0 && (
              <span className="w-4 h-4 rounded-full bg-[#f0883e]/20 text-[#ffa657] border border-[#f0883e]/40 text-[10px] flex items-center justify-center font-bold">
        ...
        <div className="flex items-center gap-1.5 text-xs text-[#3fb950] font-medium bg-[#238636]/10 px-2.5 py-1 rounded-full border border-[#238636]/30">
