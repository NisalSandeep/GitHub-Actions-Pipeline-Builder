...
export const NodeIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', size, ...props }) => (
  ...
  >
    {/* Node.js 3D Hexagon */}
    <path
      d="M128 0L255.3 73.5V220.5L128 288.5L0.7 220.5V73.5L128 0Z"
      fill="#339933"
    />
    <path
      d="M128 14.5L242.8 80.8V213.2L128 274L13.2 213.2V80.8L128 14.5Z"
      fill="#026E00"
    />
    <path
      d="M128 28.5L230 87.5V206.5L128 260.5L26 206.5V87.5L128 28.5Z"
      fill="#339933"
    />
    {/* Stylized JS glyph */}
    <path
      d="M128 65L198 105.4V186.2L128 226.6L58 186.2V105.4L128 65Z"
      fill="#215732"
    />
    <path
